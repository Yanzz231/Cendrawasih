        ...
        <div className="bg-gray-50">
            <div className="bg-gray-50 ">
                <div className="flex flex-col items-center">
                    <div className="flex justify-center mr-200 mb-2">
                        <p className="text-gray-900 text-3xl">{data.title}</p>
                    </div>
                    <div className="flex justify-center mr-200 mb-2">
                        <p className="text-gray-900 text-3xl">{data.description}</p>
                    </div>
            ...
            <div className="bg-gray-50">
                <div className={`flex justify-center items-center mt-8 ${like ? "text-pink-500" : "text-black"}`}>
                ...
                <div className="flex justify-center items-center mt-8 mb-10">
                    ...
                    <div className="ml-4">
                        <p className="text-gray-900 text-xl">Uploaded by {user.username}</p>
                    </div>
                </div>
            </div>
